...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ununifi", "auction", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"ununifi", "auction", "auctions", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AuctionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ununifi", "auction", "auctions"}, "", runtime.AssumeColonVerbOpt(false)))
)
