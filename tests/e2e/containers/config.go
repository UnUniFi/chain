...
const (
	...
	CurrentBranchOsmoRepository = "ununifi"
	CurrentBranchOsmoTag        = "debug"
	// Pre-upgrade osmosis repo/tag to pull.
	// It should be uploaded to Docker Hub. OSMOSIS_E2E_SKIP_UPGRADE should be unset
	// for this functionality to be used.
	previousVersionOsmoRepository = "UnUniFi/chain"
	previousVersionOsmoTag        = "main"
	// Pre-upgrade repo/tag for osmosis initialization (this should be one version below upgradeVersion)
	previousVersionInitRepository = "UnUniFi/chain"
	previousVersionInitTag        = "main"
