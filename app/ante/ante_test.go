			...
			stdTx := helpers.GenTx(
				[]sdk.Msg{
					bank.NewMsgSend(
						tc.address,
						testAddresses[0],
						sdk.NewCoins(sdk.NewInt64Coin("ujsmn", 1_000_000)),
					),
				},
				sdk.NewCoins(), // no fee
	...
	pfGenesis := pricefeed.GenesisState{
		Params: pricefeed.Params{
			Markets: []pricefeed.Market{
				{MarketID: "btc:jpy", BaseAsset: "btc", QuoteAsset: "jpy", Oracles: oracles, Active: true},
				{MarketID: "xrp:jpy", BaseAsset: "xrp", QuoteAsset: "jpy", Oracles: oracles, Active: true},
			},
		},
	}
