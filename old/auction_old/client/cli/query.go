...
import (
	...
	"github.com/lcnem/jpyx/x/auction/client/common"
...
Example:
$ jpyxcli q auction auctions --type=(collateral|surplus|debt)
$ jpyxcli q auction auctions --owner=kava1hatdq32u5x4wnxrtv5wzjzmq49sxgjgsj0mffm
$ jpyxcli q auction auctions --denom=bnb
$ jpyxcli q auction auctions --phase=(forward|reverse)
$ jpyxcli q auction auctions --page=2 --limit=100
`,
		),
		RunE: func(cmd *cobra.Command, args []string) error {
