...
var (
	...
	DefaultPreviojpyistributionTime     = tmtime.Canonical(time.Unix(0, 0))
...
func NewGenesisState(params Params, cdps CDPs, deposits Deposits, startingCdpID uint64,
	debtDenom, govDenom string, previojpyistTime time.Time, savingsRateDist sdk.Int) GenesisState {
	return GenesisState{
		Params:                   params,
		CDPs:                     cdps,
		Deposits:                 deposits,
		...
		DebtDenom:                debtDenom,
		GovDenom:                 govDenom,
		PreviojpyistributionTime: previojpyistTime,
...
func (gs GenesisState) Validate() error {
	...
	if gs.PreviojpyistributionTime.Unix() <= 0 {
