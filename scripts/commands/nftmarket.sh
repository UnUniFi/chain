...
ununifid tx nftmarket listing a10 a10 --min-bid=1 --bid-token=uguu --bid-active-rank=2 --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
...
ununifid tx nftmarket placebid a10 a10 100uguu --automatic-payment=true --chain-id=test --from=debug --keyring-backend=test --gas=300000 -y --broadcast-mode=block
