...
ununifid tx yieldaggregator proposal-remove-yieldfarm --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
ununifid tx yieldaggregator proposal-stop-yieldfarm --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
ununifid tx yieldaggregator proposal-update-yieldfarm --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --assetmanagement-account-name="Osmosis Farm" --enabled=true --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block


ununifid tx yieldaggregator proposal-add-yieldfarmtarget --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --assetmanagement-account-address="" --assetmanagement-target-id="OsmosisGUUFarm" --unbonding-seconds=10 --asset-conditions="uguu:1:2,stake:10:2" --integration-type="GOLANG_MOD" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
ununifid tx yieldaggregator proposal-update-yieldfarmtarget --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --assetmanagement-account-address="" --assetmanagement-target-id="OsmosisGUUFarm" --unbonding-seconds=10 --asset-conditions="uguu:1:2,stake:10:2" --integration-type="GOLANG_MOD" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
ununifid tx yieldaggregator proposal-remove-yieldfarmtarget --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --assetmanagement-target-id="OsmosisGUUFarm" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
ununifid tx yieldaggregator proposal-stop-yieldfarmtarget --title="title" --description="description" --deposit=1000000uguu --assetmanagement-account-id="OsmosisFarm" --assetmanagement-target-id="OsmosisGUUFarm" --chain-id=test --from=validator --keyring-backend=test --gas=300000 -y --broadcast-mode=block
