...
wget https://raw.githubusercontent.com/UnUniFi/network/test/upgrade-v1/test/upgrade-v1-beta4/genesis-mainnet-mock-added-users-upgrade-v1-beta4.json -O  ~/.ununifi/config/genesis.json
