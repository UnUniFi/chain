...
cd $HOME
sudo rm -rf ~/.ununifi
ununifid init ununifi-upgrade-test-v1-beta4 --chain-id ununifi-upgrade-test--beta4
wget https://raw.githubusercontent.com/UnUniFi/network/test/upgrade-v1/test/genesis-mainnet-mock.json  -O  ~/.ununifi/config/genesis.json;
sed -i 's/ununifi-upgrade-test-v1/ununifi-upgrade-test-v1-beta4/' ~/.ununifi/config/genesis.json;
...
ununifid gentx validator-a 120000000000000uguu --chain-id ununifi-upgrade-test-v1-beta4 --keyring-backend test;
