...
# docker run -v $(PWD):/app -w /app ekofr/gomock:go-1.17 \
#   mockgen -source=x/nftmint/types/expected_keepers.go -package testutil -destination x/nftmint/types/testutil/expected_keepers_mocks.go

# $mockgen_cmd -source=x/nftmint/types/expected_keepers.go -package testutil -destination x/nftmint/types/testutil/expected_keepers_mocks.go


# docker run -v $PWD:/app -w /app ekofr/gomock:go-1.17 mockgen -source=x/nftmint/types/expected_keepers.go -package testutil -destination x/nftmint/types/testutil/expected_keepers_mocks.go
