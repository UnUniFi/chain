...
func request_Query_Balances_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryGetBalancesRequest
	var metadata runtime.ServerMetadata
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"botany", "botanydist", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Balances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"botany", "botanydist", "balances"}, "", runtime.AssumeColonVerbOpt(false)))
)
