...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ununifi", "ununifidist", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Balances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ununifi", "ununifidist", "balances"}, "", runtime.AssumeColonVerbOpt(false)))
)
