...
var (
	...
	KeyMinimumBorrowJPYValue     = []byte("MinimumBorrowJPYValue")
	DefaultMoneyMarkets          = MoneyMarkets{}
	DefaultMinimumBorrowJPYValue = sdk.NewDec(10) // $10 JPY minimum borrow value
...
type Params struct {
	...
	MinimumBorrowJPYValue sdk.Dec      `json:"minimum_borrow_jpy_value" yaml:"minimum_borrow_jpy_value"`
}
...
func (bl BorrowLimit) Validate() error {
	if bl.MaximumLimit.IsNegative() {
		return fmt.Errorf("maximum limit JPY cannot be negative: %s", bl.MaximumLimit)
	}
...
func NewParams(moneyMarkets MoneyMarkets, minimumBorrowJPYValue sdk.Dec) Params {
	return Params{
		MoneyMarkets:          moneyMarkets,
		MinimumBorrowJPYValue: minimumBorrowJPYValue,
	}
}

// DefaultParams returns default params for hard module
func DefaultParams() Params {
	return NewParams(DefaultMoneyMarkets, DefaultMinimumBorrowJPYValue)
}

// String implements fmt.Stringer
func (p Params) String() string {
	return fmt.Sprintf(`Params:
	Minimum Borrow JPY Value: %v
	Money Markets: %v`,
		p.MinimumBorrowJPYValue, p.MoneyMarkets)
}
...
func (p *Params) ParamSetPairs() params.ParamSetPairs {
	return params.ParamSetPairs{
		...
		params.NewParamSetPair(KeyMinimumBorrowJPYValue, &p.MinimumBorrowJPYValue, validateMinimumBorrowJPYValue),
	}
}

// Validate checks that the parameters have valid values.
func (p Params) Validate() error {
	if err := validateMinimumBorrowJPYValue(p.MinimumBorrowJPYValue); err != nil {
		return err
	}
...
func validateMinimumBorrowJPYValue(i interface{}) error {
	...
	if minBorrowVal.IsNegative() {
		return fmt.Errorf("Minimum borrow JPY value cannot be negative")
	}
