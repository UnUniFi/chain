...
type GenesisState struct {
	...
	PreviojpyistributionTimes GenesisDistributionTimes `json:"previous_distribution_times" yaml:"previous_distribution_times"`
	Deposits                  Deposits                 `json:"deposits" yaml:"deposits"`
	Claims                    Claims                   `json:"claims" yaml:"claims"`
}

// NewGenesisState returns a new genesis state
func NewGenesisState(params Params, previousBlockTime time.Time, previojpyistTimes GenesisDistributionTimes, deposits Deposits, claims Claims) GenesisState {
	return GenesisState{
		Params:                    params,
		PreviousBlockTime:         previousBlockTime,
		PreviojpyistributionTimes: previojpyistTimes,
		Deposits:                  deposits,
		Claims:                    claims,
	}
}
...
func (gs GenesisState) Validate() error {
	...
	for _, gdt := range gs.PreviojpyistributionTimes {
		if gdt.PreviojpyistributionTime.Equal(time.Time{}) {
...
func DefaultGenesisState() GenesisState {
	return GenesisState{
		...
		PreviojpyistributionTimes: DefaultDistributionTimes,
...
type GenesisDistributionTime struct {
	...
	PreviojpyistributionTime time.Time `json:"previous_distribution_time" yaml:"previous_distribution_time"`
}
