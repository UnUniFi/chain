	...
	testCases := []borrowTest{
		{
			...
			args{
				...
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*JPYX_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF))),
			},
			errArgs{
				expectPass:   true,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
			},
			errArgs{
				expectPass:   true,
				expectDelete: true,
		...
		},
		{
			...
			args{
				...
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*JPYX_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(80*KAVA_CF))), // Deposit less so user still has some KAVA
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(60*KAVA_CF))), // Exceeds borrowed coins but not user's balance
			},
			errArgs{
				expectPass:   true,
				expectDelete: true,
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*KAVA_CF))),
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("repayer"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(49*KAVA_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*JPYX_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))), // Exceeds repayer's balance, but not borrow amount
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
				contains:     "account can only repay up to 49000000ujsmn",
			},
		},
		{
			"invalid: repaying a single coin type results in borrow position below the minimum JPY value",
			args{
				borrower:             sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*JPYX_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(50*JPYX_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(45*JPYX_CF))),
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
				contains:     "proposed borrow's JPY value $5.000000000000000000 is below the minimum borrow limit",
			},
		},
		{
			"invalid: repaying multiple coin types results in borrow position below the minimum JPY value",
			args{
				borrower:             sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*JPYX_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(50*JPYX_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF))), // (50*$1)+(10*$2) = $70
				repayCoins:           sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(45*JPYX_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(8*KAVA_CF))),  // (45*$1)+(8*$2) = $61
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
				contains:     "proposed borrow's JPY value $9.000000000000000000 is below the minimum borrow limit",
			},
		},
		{
			"invalid: overpaying multiple coin types results in borrow position below the minimum JPY value",
			args{
				borrower:             sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(100*JPYX_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(50*JPYX_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF))), // (50*$1)+(10*$2) = $70
				repayCoins:           sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(500*JPYX_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(8*KAVA_CF))), // (500*$1)+(8*$2) = $516, or capping to borrowed amount, (50*$1)+(8*$2) = $66
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
				contains:     "proposed borrow's JPY value $4.000000000000000000 is below the minimum borrow limit",
			},
		},
	}
