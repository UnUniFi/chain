...
import (
	...
	aucKeeper "github.com/lcnem/jpyx/x/auction/keeper"
	"github.com/lcnem/jpyx/x/hard/keeper"
...
func (suite *KeeperTestSuite) TestGetSetDeleteInterestRateModel() {
	...
	moneyMarket := types.NewMoneyMarket(denom, borrowLimit, denom+":jpy", sdk.NewInt(1000000), model, sdk.MustNewDecFromStr("0.05"), sdk.ZeroDec())
