...
import (
	...
	auctypes "github.com/lcnem/jpyx/x/auction/types"
	...
	testCases := []liqTest{
		{
			...
			args{
				...
				initialModuleCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF))),
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(8*KAVA_CF))),
				liquidateAfter:             oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ujsmn", 100004118)),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100500020))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(98000001))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: auctypes.Auctions{
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 9500390),
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("ujsmn", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ujsmn", 8004766),
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF))),                                                                                                                                     // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("jpyc", sdk.NewInt(20*KAVA_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(10*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.2*BTCB_CF))), // $20+$20+$20 = $80 borrowed
				liquidateAfter:       oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ujsmn", 1000000710),
					sdk.NewInt64Coin("jpyc", 1000003120),
					sdk.NewInt64Coin("bnb", 100000003123),
					sdk.NewInt64Coin("btc", 100000000031),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(102500001))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("jpyc", sdk.NewInt(20*KAVA_CF)), sdk.NewCoin("ujsmn", sdk.NewInt(60000002)), sdk.NewCoin("bnb", sdk.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.2*BTCB_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: auctypes.Auctions{
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 11874430),
							Bidder:          nil,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              2,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 11874254),
							Bidder:          nil,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 11875163),
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("ujsmn", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ujsmn", 10000782),
						LotReturns:        lotReturns,
					},
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              4,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 11876185),
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("jpyc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("jpyc", 20003284),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(100*BTCB_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(50*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF))), // $100 + $100 + $100 = $300 * 0.8 = $240 borrowable                                                                                                                                       // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(120*KAVA_CF))),                                                                                      // $240 borrowed
				liquidateAfter:       oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ujsmn", 1000101456),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(102500253)), sdk.NewCoin("bnb", sdk.NewInt(0.5*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.05*BTCB_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(170.000001*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(90*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(99*BTCB_CF))),
				expectedAuctions: auctypes.Auctions{
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              1,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ujsmn", 40036023),
						LotReturns:        lotReturns,
					},
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ujsmn", 47504818),
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("ujsmn", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ujsmn", 40040087),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(100*KAVA_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("jpyc", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(100*KAVA_CF))), // $100 + $100 + $100 = $300 * 0.9 = $270 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(35*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF))),       // $270 borrowed
				liquidateAfter:       oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("bnb", 100000078047),
					sdk.NewInt64Coin("btc", 100000000780),
					sdk.NewInt64Coin("ujsmn", 1000009550),
					sdk.NewInt64Coin("jpyx", 1),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(5*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(5*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(5*KAVA_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(135*KAVA_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF)), sdk.NewCoin("jpyx", sdk.NewInt(0.000001*KAVA_CF))),
				expectedAuctions: auctypes.Auctions{
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyc", 95000000), // $95.00
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("bnb", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              2,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyt", 10552835), // $10.55
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("bnb", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyt", 84447165), // $84.45
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("btc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              4,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyx", 21097866), // $21.10
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("btc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
					...
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              5,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyx", 73902133), //$73.90
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("ujsmn", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ujsmn", 35010052), // $70.02
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(1000*KAVA_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(1000*KAVA_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("jpyx", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(1000*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(350*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(200*KAVA_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("jpyt", sdk.NewInt(250*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(245*KAVA_CF))),
				liquidateAfter:       oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("dai", 1000000000),
					sdk.NewInt64Coin("jpyc", 1000000001),
					sdk.NewInt64Coin("jpyt", 1000482503),
					sdk.NewInt64Coin("jpyx", 1000463500),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(1017.50*KAVA_CF)), sdk.NewCoin("jpyt", sdk.NewInt(1000*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(1010*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1000*KAVA_CF))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(650*KAVA_CF)), sdk.NewCoin("jpyc", sdk.NewInt(800000001)), sdk.NewCoin("jpyt", sdk.NewInt(1250*KAVA_CF)), sdk.NewCoin("jpyx", sdk.NewInt(1245*KAVA_CF))),
				expectedAuctions: auctypes.Auctions{
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              1,
							...
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("jpyt", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("jpyt", 250507897),
						LotReturns:        lotReturns,
					},
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							...
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("jpyx", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("jpyx", 65125788),
						LotReturns:        lotReturns,
					},
					auctypes.CollateralAuction{
						BaseAuction: auctypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("jpyc", 189999999),
							Bidder:          nil,
							Bid:             sdk.NewInt64Coin("jpyx", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("jpyx", 180362106),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100*KAVA_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(20*KAVA_CF))), // Deposit 20 KAVA
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(5*KAVA_CF))),  // Borrow 5 KAVA
				liquidateAfter:             oneMonthInSeconds,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(120001624))),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(5001709))),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ujsmn", sdk.NewInt(100.5*KAVA_CF))),
			...
			pricefeedGS := pricefeed.GenesisState{
				Params: pricefeed.Params{
					Markets: []pricefeed.Market{
						...
						{MarketID: "jpyt:jpy", BaseAsset: "jpyt", QuoteAsset: "jpy", Oracles: []sdk.AccAddress{}, Active: true},
						{MarketID: "jpyc:jpy", BaseAsset: "jpyc", QuoteAsset: "jpy", Oracles: []sdk.AccAddress{}, Active: true},
						{MarketID: "dai:jpy", BaseAsset: "dai", QuoteAsset: "jpy", Oracles: []sdk.AccAddress{}, Active: true},
