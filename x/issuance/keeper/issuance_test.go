...
func (suite *KeeperTestSuite) TestGetSetParams() {
	...
	asset := types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{suite.addrs[1]}, false, true, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0)))
...
func (suite *KeeperTestSuite) TestIssueTokens() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{suite.addrs[1]}, false, true, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0))),
				},
				sender:   suite.addrs[0],
				tokens:   sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
		...
		},
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{suite.addrs[1]}, true, true, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0))),
				},
				sender:   suite.addrs[0],
				tokens:   sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
				receiver: suite.addrs[1],
...
func (suite *KeeperTestSuite) TestIssueTokensRateLimited() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{suite.addrs[1]}, false, true, types.NewRateLimit(true, sdk.NewInt(10000000000), time.Hour*24)),
				},
				supplies: types.AssetSupplies{
					types.NewAssetSupply(sdk.NewCoin("jpytoken", sdk.ZeroInt()), time.Hour),
				},
				sender:    suite.addrs[0],
				tokens:    sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
				receiver:  suite.addrs[2],
		...
		},
		{
			...
			args{
				...
				sender:    suite.addrs[0],
				tokens:    sdk.NewCoin("jpytoken", sdk.NewInt(10000000001)),
				receiver:  suite.addrs[2],
				blockTime: suite.ctx.BlockTime().Add(time.Hour),
			},
			errArgs{
	...
	testCases := []struct {
	...
	}{
		{
			...
			args{
				...
				sender:        suite.addrs[0],
				initialTokens: sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
				redeemTokens:  sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				sender:        suite.addrs[0],
				initialTokens: sdk.NewCoin("jpytoken", sdk.NewInt(100000)),
				redeemTokens:  sdk.NewCoin("jpytoken", sdk.NewInt(200000)),
			},
			errArgs{
				expectPass: false,
...
func (suite *KeeperTestSuite) TestBlockAddress() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{}, false, true, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0))),
				},
				sender:      suite.addrs[0],
		...
		},
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{}, false, false, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0))),
				},
				sender:      suite.addrs[0],
				blockedAddr: suite.addrs[1],
				denom:       "jpytoken",
...
func (suite *KeeperTestSuite) TestChangePauseStatus() {
	...
	testCases := []struct {
		...
		},
		{
			...
			args{
				assets: types.Assets{
					types.NewAsset(suite.addrs[0], "jpytoken", []sdk.AccAddress{}, true, true, types.NewRateLimit(false, sdk.ZeroInt(), time.Duration(0))),
				},
				sender:      suite.addrs[0],
				startStatus: true,
				endStatus:   false,
	...
	testCases := []struct {
	...
	}{
		{
			...
			args{
				...
				initialCoins: sdk.NewCoin("jpytoken", sdk.NewInt(100000000)),
				denom:        "jpytoken",
