...
import (
	...
	icacallbacktypes "github.com/UnUniFi/chain/x/yieldaggregator/ibcstaking/icacallbacks/types"

	"github.com/UnUniFi/chain/x/yieldaggregator/ibcstaking/stakeibc/keeper"
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	if err != nil {
		errMsg := fmt.Sprintf("Unable to call registered callback from stakeibc OnAcknowledgePacket | Sequence %d, from %s %s, to %s %s | Log: %s",
