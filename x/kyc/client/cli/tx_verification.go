...
func CmdCreateVerification() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-verification [index]",
		Short: "Create a new verification",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgCreateVerification(
...
func CmdDeleteVerification() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgDeleteVerification(
				clientCtx.GetFromAddress().String(),
				indexIndex,
			)
			if err := msg.ValidateBasic(); err != nil {
