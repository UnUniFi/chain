...
on-chain incentives for users who open cdps and mint stablecoins (JPYX).
...
will distribute 1000 KAVA each week (Duration) to users who mint JPYX using collateral bnb.
...
minted 10% of all JPYX backed by bnb for the entire reward period, they will be eligible to claim 10%
...
will claim all outstanding rewards for minting JPYX backed by bnb for the input user.
