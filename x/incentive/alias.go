...
var (
	...
	NewQueryJPYXMintingRewardsParams       = types.NewQueryJPYXMintingRewardsParams
	NewRewardIndex                         = types.NewRewardIndex
	NewRewardPeriod                        = types.NewRewardPeriod
	NewJPYXMintingClaim                    = types.NewJPYXMintingClaim
	...
	DefaultJPYXClaims                               = types.DefaultJPYXClaims
	...
	PreviousJPYXMintingRewardAccrualTimeKeyPrefix   = types.PreviousJPYXMintingRewardAccrualTimeKeyPrefix
	PrincipalDenom                                  = types.PrincipalDenom
	JPYXMintingClaimKeyPrefix                       = types.JPYXMintingClaimKeyPrefix
	JPYXMintingRewardDenom                          = types.JPYXMintingRewardDenom
	JPYXMintingRewardFactorKeyPrefix                = types.JPYXMintingRewardFactorKeyPrefix
)
...
type (
	...
	QueryJPYXMintingRewardsParams       = types.QueryJPYXMintingRewardsParams
	...
	JPYXMintingClaim                    = types.JPYXMintingClaim
	JPYXMintingClaims                   = types.JPYXMintingClaims
)
