		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.000000856478000001")),
				},
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.010571385600010177")),
				},
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.0")),
				},
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.010571385600010177")),
					types.NewRewardIndex("ujsmn", d("0.047999952000046210")),
				},
			},
		},
	}
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.001223540000173228")),
				},
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("10.571385603126235340")),
				},
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.001223540000173228")),
					types.NewRewardIndex("ujsmn", d("0.005555550000786558")),
				},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.864000000049120715")),
				},
				updatedTimeDuration: 86400,
			},
		},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.864000000049803065")),
					types.NewRewardIndex("ujsmn", d("0.868320000050052081")),
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.000000856478000000")),
				},
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.010571385600000000")),
				},
			},
		},
		{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.010571385600000000")),
					types.NewRewardIndex("ujsmn", d("0.047999952000000000")),
				},
			},
		},
		{
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.001223540000000000")),
				},
				expectedRewards:            cs(c("hard", 12235400), c("ujsmn", 12235400)),
				updateRewardsViaCommmittee: false,
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("10.571385600000000000")),
				},
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.001223540000000000")),
					types.NewRewardIndex("ujsmn", d("0.005555550000000000")),
				},
				expectedRewards:            cs(c("hard", 12235400), c("ujsmn", 55555500)),
				updateRewardsViaCommmittee: false,
			},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ujsmn", d("0.864000000000000000")),
				},
				updatedTimeDuration: 86400,
			},
		},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.864")),
					types.NewRewardIndex("ujsmn", d("0.86832")),
	...
	testCases := []test{
		{
			...
			args{
				...
				initialTime:           time.Date(2020, 12, 15, 14, 0, 0, 0, time.UTC),
				blockTimes:            []int{10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
				expectedRewardIndexes: types.RewardIndexes{types.NewRewardIndex("ujsmn", d("6.117700000000000000"))}, // Here the reward index stores data differently than inside a MultiRewardIndex
				expectedRewards:       cs(c("hard", 6117700)),
			},
		},
		{
			...
			args{
				...
				initialTime:           time.Date(2020, 12, 15, 14, 0, 0, 0, time.UTC),
				blockTimes:            []int{86400, 86400, 86400, 86400, 86400, 86400, 86400, 86400, 86400, 86400},
				expectedRewardIndexes: types.RewardIndexes{types.NewRewardIndex("ujsmn", d("52856.928000000000000000"))},
				expectedRewards:       cs(c("hard", 52856928000)),
			},
		},
	}
