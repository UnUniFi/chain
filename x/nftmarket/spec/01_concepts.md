...
### listing cancel
1. 次の条件のいずれかの満たしている場合、出品者は出品キャンセルすることができる
    - 入札が無い場合
    - 出品者がプロトコルからトークンを借りていない、かつ入札が最低落札価格以下の場合
1. それ以外の場合は、出品者は出品キャンセル手数料を支払うことで出品キャンセルすることができる
