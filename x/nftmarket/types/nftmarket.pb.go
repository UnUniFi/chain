...
type EventCancelBid struct {
	...
	NftId   string `protobuf:"bytes,3,opt,name=nft_id,json=nftId,proto3" json:"nft_id,omitempty"`
	// below properties are only for the poc
	MaxBorrowableAmount *types.Coin `protobuf:"bytes,4,opt,name=max_borrowable_amount,json=maxBorrowableAmount,proto3" json:"max_borrowable_amount,omitempty"`
}
...
func (m *EventCancelBid) GetMaxBorrowableAmount() *types.Coin {
	if m != nil {
		return m.MaxBorrowableAmount
	}
	return nil
...
type EventPayFullBid struct {
	...
	NftId   string `protobuf:"bytes,3,opt,name=nft_id,json=nftId,proto3" json:"nft_id,omitempty"`
	// below properties are only for the poc
	BorrowingAmount *types.Coin `protobuf:"bytes,4,opt,name=borrowing_amount,json=borrowingAmount,proto3" json:"borrowing_amount,omitempty"`
}
...
func (m *EventPayFullBid) GetBorrowingAmount() *types.Coin {
	if m != nil {
		return m.BorrowingAmount
	}
	return nil
...
type EventBorrow struct {
	...
	Amount   string `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`
	// below properties are only for the poc
	BorrowingAmount *types.Coin `protobuf:"bytes,5,opt,name=borrowing_amount,json=borrowingAmount,proto3" json:"borrowing_amount,omitempty"`
}
...
func (m *EventBorrow) GetBorrowingAmount() *types.Coin {
	if m != nil {
		return m.BorrowingAmount
	}
	return nil
...
var fileDescriptor_f0570683065f368b = []byte{
	...
	,
}
...
func (m *EventNftlistingDeleted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EndAt != nil {
		n26, err26 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.EndAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.EndAt):])
		if err26 != nil {
			return 0, err26
		}
		i -= n26
