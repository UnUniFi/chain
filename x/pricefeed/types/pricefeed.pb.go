...
type DenomTickerPair struct {
	Denom  string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty" yaml:"denom"`
	Ticker string `protobuf:"bytes,2,opt,name=ticker,proto3" json:"ticker,omitempty" yaml:"ticker"`
}

func (m *DenomTickerPair) Reset()         { *m = DenomTickerPair{} }
func (m *DenomTickerPair) String() string { return proto.CompactTextString(m) }
func (*DenomTickerPair) ProtoMessage()    {}
func (*DenomTickerPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_c81c86fbf8838e8b, []int{3}
}
func (m *DenomTickerPair) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DenomTickerPair) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DenomTickerPair.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DenomTickerPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DenomTickerPair.Merge(m, src)
}
func (m *DenomTickerPair) XXX_Size() int {
	return m.Size()
}
func (m *DenomTickerPair) XXX_DiscardUnknown() {
	xxx_messageInfo_DenomTickerPair.DiscardUnknown(m)
}

var xxx_messageInfo_DenomTickerPair proto.InternalMessageInfo

func (m *DenomTickerPair) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *DenomTickerPair) GetTicker() string {
	if m != nil {
		return m.Ticker
	}
	return ""
...
type Params struct {
	...
	DenomTickerPairs []DenomTickerPair `protobuf:"bytes,2,rep,name=denom_ticker_pairs,json=denomTickerPairs,proto3" json:"denom_ticker_pairs" yaml:"denom_ticker_pairs"`
}
...
func (m *Params) GetDenomTickerPairs() []DenomTickerPair {
	if m != nil {
		return m.DenomTickerPairs
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*DenomTickerPair)(nil), "ununifi.pricefeed.DenomTickerPair")
...
var fileDescriptor_c81c86fbf8838e8b = []byte{
	...
	,
}
...
func (m *DenomTickerPair) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DenomTickerPair) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DenomTickerPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Ticker) > 0 {
		...
		i = encodeVarintPricefeed(dAtA, i, uint64(len(m.Ticker)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Denom) > 0 {
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DenomTickerPairs) > 0 {
		for iNdEx := len(m.DenomTickerPairs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DenomTickerPairs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DenomTickerPair) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Size() (n int) {
	...
	if len(m.DenomTickerPairs) > 0 {
		for _, e := range m.DenomTickerPairs {
			l = e.Size()
			n += 1 + l + sovPricefeed(uint64(l))
		}
	}
...
func (m *DenomTickerPair) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DenomTickerPair: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DenomTickerPair: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DenomTickerPairs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DenomTickerPairs = append(m.DenomTickerPairs, DenomTickerPair{})
			if err := m.DenomTickerPairs[len(m.DenomTickerPairs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
