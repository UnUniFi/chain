...
echo "------------price change------------"
ununifid tx pricefeed postprice ubtc:usd 0.030508410211260500 1200 \
...
user1_loss=$(( $init_ubtc_balance - $user1_ubtc_balance))
user2_profit=$(( $user2_ubtc_balance - $init_user2_ubtc_balance))

if [ "$user1_ubtc_balance" -lt "$init_ubtc_balance" ]; then
...
if [ "$user2_ubtc_balance" -gt "$init_user2_ubtc_balance" ]; then
