...
type FrontendTxMemo struct {
	Frontend *FrontendMetadata `protobuf:"bytes,1,opt,name=frontend,proto3" json:"frontend,omitempty" yaml:"frontend"`
}

func (m *FrontendTxMemo) Reset()         { *m = FrontendTxMemo{} }
func (m *FrontendTxMemo) String() string { return proto.CompactTextString(m) }
func (*FrontendTxMemo) ProtoMessage()    {}
func (*FrontendTxMemo) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a43f0dcca886bed, []int{0}
}
func (m *FrontendTxMemo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FrontendTxMemo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FrontendTxMemo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *FrontendTxMemo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FrontendTxMemo.Merge(m, src)
}
func (m *FrontendTxMemo) XXX_Size() int {
	return m.Size()
}
func (m *FrontendTxMemo) XXX_DiscardUnknown() {
	xxx_messageInfo_FrontendTxMemo.DiscardUnknown(m)
}

var xxx_messageInfo_FrontendTxMemo proto.InternalMessageInfo

func (m *FrontendTxMemo) GetFrontend() *FrontendMetadata {
	if m != nil {
		return m.Frontend
	}
	return nil
...
func (*FrontendMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a43f0dcca886bed, []int{1}
}
...
func init() {
	proto.RegisterType((*FrontendTxMemo)(nil), "ununifi.ecosystemincentive.FrontendTxMemo")
...
var fileDescriptor_6a43f0dcca886bed = []byte{
	...
	,
}

func (m *FrontendTxMemo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *FrontendTxMemo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FrontendTxMemo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Frontend != nil {
		{
			...
			i -= size
			i = encodeVarintMemo(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *FrontendTxMemo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FrontendTxMemo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FrontendTxMemo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FrontendTxMemo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
