...
var (
	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"lcnem", "jpyx", "auction", "auctions", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AuctionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lcnem", "jpyx", "auction", "auctions"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lcnem", "jpyx", "auction", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
