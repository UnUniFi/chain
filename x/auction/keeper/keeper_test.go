...
func SetGetDeleteAuction(t *testing.T) {
	...
	var id uint64 = 5
	auction := types.NewSurplusAuction("some_module", c("jpyx", 100), "jsmn", someTime).WithID(id)
...
func TestIterateAuctions(t *testing.T) {
	...
	auctions := []types.Auction{
		...
		types.NewCollateralAuction("sellerMod", c("denom", 12345678), time.Date(1998, time.January, 1, 0, 0, 0, 0, time.UTC), c("anotherdenom", 12345678), nil, c("debt", 12345678)).WithID(2),
	}
