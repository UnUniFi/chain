...
type Listing struct {
	...
	MinimumBidPeriod        time.Duration                          `protobuf:"bytes,6,opt,name=minimum_bid_period,json=minimumBidPeriod,proto3,stdduration" json:"minimum_bid_period"`
...
func (m *Listing) GetMinimumBidPeriod() time.Duration {
	if m != nil {
		return m.MinimumBidPeriod
	}
	return 0
}
...
var fileDescriptor_9e729891a263bcae = []byte{
	...
	,
}
...
func (m *Listing) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x3a
	n7, err7 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.MinimumBidPeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.MinimumBidPeriod):])
	if err7 != nil {
		return 0, err7
	}
	i -= n7
...
func (m *Listing) Size() (n int) {
	...
	n += 1 + l + sovNftbackedloan(uint64(l))
	l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.MinimumBidPeriod)
	n += 1 + l + sovNftbackedloan(uint64(l))
...
func (m *Listing) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinimumBidPeriod", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(&m.MinimumBidPeriod, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
