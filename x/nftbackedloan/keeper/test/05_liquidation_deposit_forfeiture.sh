...
ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 ununifi155u042u8wk3al32h3vzxu989jj76k4zcu44v6w \
...
ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 \
...
ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 \
200uguu 100uguu 0.1 30 --automatic-payment=false --from user2 --keyring-backend test --chain-id test --yes
...
ununifid tx nftbackedloan place-bid \
ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 \
140uguu 20uguu 0.2 36 --from user3 --keyring-backend test --chain-id test --yes
...
ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 \
ununifi1v0h8j7x7kfys29kj4uwdudcc9y0nx6twwxahla 100uguu \
--from user1 --keyring-backend test --chain-id test --yes

sleep $sleep
ununifid q nftbackedloan nft-bids ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05

echo "wait.......... Bid expire"
sleep 30

echo "============check nft status liquidation ============"
ununifid q nftbackedloan nft-listing ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05
ununifid q nftbackedloan nft-bids ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05
...
# check forfeited bidder balance
user2_balance=$(ununifid q bank balances ununifi1v0h8j7x7kfys29kj4uwdudcc9y0nx6twwxahla --denom uguu -o json | jq .amount | tr -d '"')
# -100 (deposit)
expected_user2_balance=$((init_user2_balance - 100))

if [ "$user2_balance" = "$expected_user2_balance" ]; then
  echo "pass: forfeited bidder balance is correct: $user2_balance"
else
  echo "error: forfeited bidder balance is incorrect"
...
# + 100 (borrow) + 240 - 100 - 7(fee) = 233
expected_user1_balance=$((init_user1_balance + 233))
...
owner=$(ununifid q nft owner ununifi-1AFC3C85B52311F13161F724B284EF900458E3B3 a05 -o json | jq .owner | tr -d '"')
# user3
