...
func (suite *CdpValidationSuite) TestCdpValidation() {
	...
	testCases := []struct {
		...
		{
			name: "valid cdp",
			cdp:  types.NewCDP(1, suite.addrs[0], sdk.NewInt64Coin("bnb", 100000), sdk.NewInt64Coin("jpyx", 100000), tmtime.Now()),
			errArgs: errArgs{
				expectPass: true,
				contains:   "",
			},
		...
		{
			name: "invalid cdp id",
			cdp:  types.NewCDP(0, suite.addrs[0], sdk.NewInt64Coin("bnb", 100000), sdk.NewInt64Coin("jpyx", 100000), tmtime.Now()),
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types.CDP{1, suite.addrs[0], sdk.Coin{"", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(0)}, tmtime.Now()},
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types.CDP{1, suite.addrs[0], sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(0)}, tmtime.Now()},
			errArgs: errArgs{
				expectPass: false,
		...
		{
			name: "invalid fees",
			cdp:  types.CDP{1, suite.addrs[0], sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(100)}, sdk.Coin{"", sdk.NewInt(0)}, tmtime.Now()},
			errArgs: errArgs{
				expectPass: false,
		...
		},
		{
			...
			cdp:  types.CDP{1, suite.addrs[0], sdk.Coin{"xrp", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(100)}, sdk.Coin{"jpyx", sdk.NewInt(0)}, time.Time{}},
			errArgs: errArgs{
				expectPass: false,
...
func (suite *CdpValidationSuite) TestCdpGetTotalPrinciple() {
	...
	acummulatedFees := sdk.Coin{"jpyx", sdk.NewInt(25000)}
