	...
	pfGenesis := pricefeedtypes.GenesisState{
		Params: pricefeedtypes.Params{
			Markets: []pricefeedtypes.Market{
				{MarketId: asset + ":jpy", BaseAsset: asset, QuoteAsset: "jpy", Oracles: jpyxtypes.StringAccAddresses([]sdk.AccAddress{}), Active: true},
			},
		},
...
func NewPricefeedGenStateMulti() app.GenesisState {
	pfGenesis := pricefeedtypes.GenesisState{
		Params: pricefeedtypes.Params{
			Markets: []pricefeedtypes.Market{
				{MarketId: "btc:jpy", BaseAsset: "btc", QuoteAsset: "jpy", Oracles: jpyxtypes.StringAccAddresses([]sdk.AccAddress{}), Active: true},
				{MarketId: "xrp:jpy", BaseAsset: "xrp", QuoteAsset: "jpy", Oracles: jpyxtypes.StringAccAddresses([]sdk.AccAddress{}), Active: true},
			},
		},
		PostedPrices: []pricefeedtypes.PostedPrice{
			{
...
func cdps() (cdps cdptypes.Cdps) {
	...
	c1 := cdptypes.NewCdp(uint64(1), addrs[0], sdk.NewCoin("xrp", sdk.NewInt(100000000)), "xrp-a", sdk.NewCoin("jpyx", sdk.NewInt(8000000)), tmtime.Canonical(time.Now()), sdk.NewDec(0))
	...
	c4 := cdptypes.NewCdp(uint64(4), addrs[2], sdk.NewCoin("xrp", sdk.NewInt(1000000000)), "xrp-a", sdk.NewCoin("jpyx", sdk.NewInt(50000000)), tmtime.Canonical(time.Now()), sdk.NewDec(0))
