	...
	pfGenesis := pricefeedtypes.GenesisState{
		Params: pricefeedtypes.Params{
			Markets: []pricefeedtypes.Market{
				{MarketId: asset + ":usd", BaseAsset: asset, QuoteAsset: "usd", Oracles: []jpyxtypes.StringAccAddress{}, Active: true},
			},
		},
...
func cdps() (cdps cdptypes.Cdps) {
	...
	c4 := cdptypes.NewCdp(uint64(4), addrs[2], sdk.NewCoin("xrp", sdk.NewInt(1000000000)), "xrp-a", sdk.NewCoin("usdx", sdk.NewInt(500000000)), tmtime.Canonical(time.Now()), sdk.NewDec(0))
